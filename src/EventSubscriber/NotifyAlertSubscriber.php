<?php
    ...
    class NotifyAlertSubscriber implements EventSubscriberInterface
    {
        public function __construct( readonly NeoxNotifyAlertService $notifyBagService )
        {
        }
...
//            }
        ...
        public function onKernelController(ControllerArgumentsEvent $event): void
        {
            ...
            $t = $this->notifyBagService->getNeoxNotifyAlert();
